import {
  Paper_default
} from "./chunk-7FWAGFTH.js";
import {
  ButtonBase_default
} from "./chunk-WQZIVFCH.js";
import "./chunk-G4SYXZBO.js";
import {
...
import {
  capitalize_default,
  memoTheme_default
} from "./chunk-7QFPJCZB.js";
import "./chunk-D6HBEO6R.js";
import {
  useDefaultProps
} from "./chunk-IT6AYIQP.js";
import "./chunk-CZJRZIRH.js";
import {
  alpha,
  ...
  styled_default,
  useForkRef
} from "./chunk-74LKM57N.js";
import {
  require_jsx_runtime
} from "./chunk-JC3QP3U2.js";
import "./chunk-ZS654YQ7.js";
import {
  require_react
...
var SvgIcon = React2.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  return (0, import_jsx_runtime2.jsxs)(SvgIconRoot, {
    as: component,
    className: clsx_default(classes.root, className),
    focusable: "false",
    color: htmlColor,
...
function createSvgIcon(path, displayName) {
  function Component(props, ref) {
    return (0, import_jsx_runtime3.jsx)(SvgIcon_default, {
...
var Alert = React9.forwardRef(function Alert2(inProps, ref) {
  ...
  return (0, import_jsx_runtime9.jsxs)(AlertRoot, {
    role,
    elevation: 0,
    ownerState,
    className: clsx_default(classes.root, className),
    ref,
    ...other,
    children: [icon !== false ? (0, import_jsx_runtime9.jsx)(AlertIcon, {
      ownerState,
      className: classes.icon,
      children: icon || iconMapping[severity] || defaultIconMapping[severity]
    }) : null, (0, import_jsx_runtime9.jsx)(AlertMessage, {
      ownerState,
      className: classes.message,
      children
    }), action != null ? (0, import_jsx_runtime9.jsx)(AlertAction, {
      ownerState,
      className: classes.action,
      children: action
    }) : null, action == null && onClose ? (0, import_jsx_runtime9.jsx)(AlertAction, {
      ownerState,
      className: classes.action,
